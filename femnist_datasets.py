...
class FEMNIST(Dataset):
    ...
    def __init__(self, train=True, transform=None, target_transform=None, ):
        ...
        train_clients, train_groups, train_data_temp, test_data_temp = read_data("./train",
                                                                                 "./test")
        if self.train:
            self.dic_users = {}
            train_data_x = []
...
class ShakeSpeare(Dataset):
    def __init__(self, train=True):
        ...
        train_clients, train_groups, train_data_temp, test_data_temp = read_data("../data/shakes/train",
                                                                                 "../data/shakes/test")
        self.train = train
